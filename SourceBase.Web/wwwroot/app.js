...
window.renderGoldPriceChart = function (elementId, seriesData, colors, dashArray) {
  ...
  var options = {
    ...
    yaxis: {
      labels: {
        formatter: function (v) { return (v / 1000000).toFixed(2) + 'M'; },
      },
    },
    ...
    tooltip: {
      ...
      custom: function ({ series, seriesIndex, dataPointIndex, w }) {
        ...
        sources.forEach(function (src) {
          var buyIdx = w.config.series.findIndex(function (s) { return s.name === src + ' Buy'; });
          var sellIdx = w.config.series.findIndex(function (s) { return s.name === src + ' Sell'; });
