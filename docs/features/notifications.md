...
3. When a new notification is created for a user, the server invokes `GlobalNotificationEvent` on all connections in that user's group.
...
### Client Event: `GlobalNotificationEvent`
